...
public class MulticastListener extends Thread {
    ...
    public void run()
    {
        try {
            ...
            socket.joinGroup(socketAddress, NetworkInterface.getByInetAddress(UserTable.localUser().getIpAddress().getAddress()));
            while (isRunning) {
                ...
                if (userId.equals(UserTable.localUser().getUserId()))
                    continue;
